...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RepositoryDto', function() {
      beforeEach(function() {
        instance = new CompetenceRepositoryApi.RepositoryDto();
      });

      it('should create an instance of RepositoryDto', function() {
        // TODO: update the code to test RepositoryDto
        expect(instance).to.be.a(CompetenceRepositoryApi.RepositoryDto);
      });
