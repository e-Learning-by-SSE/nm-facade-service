...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UnResolvedUeberCompetenceDto', function() {
      beforeEach(function() {
        instance = new CompetenceRepositoryApi.UnResolvedUeberCompetenceDto();
      });

      it('should create an instance of UnResolvedUeberCompetenceDto', function() {
        // TODO: update the code to test UnResolvedUeberCompetenceDto
        expect(instance).to.be.a(CompetenceRepositoryApi.UnResolvedUeberCompetenceDto);
      });
