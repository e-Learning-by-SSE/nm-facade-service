...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UeberCompetenceModificationDto', function() {
      beforeEach(function() {
        instance = new CompetenceRepositoryApi.UeberCompetenceModificationDto();
      });

      it('should create an instance of UeberCompetenceModificationDto', function() {
        // TODO: update the code to test UeberCompetenceModificationDto
        expect(instance).to.be.a(CompetenceRepositoryApi.UeberCompetenceModificationDto);
      });

      it('should have the property ueberCompetenceId (base name: "ueberCompetenceId")', function() {
        // TODO: update the code to test the property ueberCompetenceId
        expect(instance).to.have.property('ueberCompetenceId');
        // expect(instance.ueberCompetenceId).to.be(expectedValueLiteral);
      });
